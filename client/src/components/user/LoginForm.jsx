...
const LoginForm = ({ setAuthFormType }) => {
  return (
    <>
      <div className='flex justify-between items-center'>
        <div>
          <p className='text-3xl font-medium mb-1'>Login</p>
          <p>
            or <span className="text-orange-500 cursor-pointer" onClick={() => setAuthFormType('signup')}>create an account</span>
          </p>
          <span>____</span>
        </div>
        <div>
      ...
      <div className="relative w-full">
        <input
          ...
          class="peer w-full h-16 px-5 pt-5 pb-1 border border-t-0 placeholder-transparent focus:outline-none focus:ring-0"
        />
        <label
          for="password"
          className="absolute left-5 text-gray-500 transition-all 
      ...
      <button className='w-full bg-orange-500 font-semibold text-white mt-5 p-4'>LOGIN</button>
